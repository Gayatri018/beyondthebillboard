...
const projects = [
  { title: "Luminary Brand", category: "Branding", image: portfolio1 },
  { title: "Classé Identity", category: "Brand Identity", image: portfolio2 },
  { title: "Minimal Packaging", category: "Packaging Design", image: portfolio3 },
  { title: "App Interfaces", category: "UI/UX Design", image: portfolio4 },
  { title: "Editorial Spread", category: "Print Design", image: portfolio5 },
  { title: "Motion Reel", category: "Motion Graphics", image: portfolio6 },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, i) => (
            <motion.div
              ...
              className="group relative rounded-xl overflow-hidden cursor-pointer bg-card"
            >
